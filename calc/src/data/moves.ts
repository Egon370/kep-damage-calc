...
const RBY: {[name: string]: MoveData} = {
  ...
  'Brutal Swing': {bp : 60, type: 'Dark'},
  Bubble: {bp: 20, type: 'Water'},
  'Bubble Beam': {bp: 65, type: 'Water'},
  'Bullet Punch': {bp: 40, type: 'Steel', priority: 1},
  ...
  'Draining Kiss': {bp: 40, type: 'Fairy', drain: [1, 2]},
  ...
  'Fairy Wind': {bp: 40, type: 'Fairy'},
  'Fake Tears': {bp: 0, category: 'Status', type: 'Normal'},
  'False Surrender': {bp: 80, type: 'Dark'},
  ...
  'Nasty Plot': {bp: 0, category: 'Status', type: 'Dark'},
  'Night Shade': {bp: 1, type: 'Ghost'},
  'Night Slash': {bp: 70, type: 'Dark'},
